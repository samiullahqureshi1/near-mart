...
const DashboardMessages = () => {
    ...
    const getConversation = async () => {
      try {
        const resonse = await axios.get(
          `https://near-backend.vercel.app/conversation/get-all-conversation-seller/${seller?._id}`,
          {
  ...
  const imageSendingHandler = async (e) => {
    ...
    try {
      await axios
        .post(`https://near-backend.vercel.app/message/create-new-message`, {
          images: e,
          sender: seller._id,
          text: newMessage,
          conversationId: currentChat._id,
...
const MessageList = ({
  ...
  useEffect(() => {
    ...
    const getUser = async () => {
      try {
        const res = await axios.get(`https://near-backend.vercel.app/api/v2/user/user-info/${userId}`);
